...
export const mockWidgets: DashboardWidget[] = [
  ...
  },
  {
    ...
    activities: [
      { id: '1', user: 'John Doe', action: 'completed 4 hours of volunteer work', time: '2 hours ago' },
      { id: '2', user: 'Jane Smith', action: 'raised $250 for education', time: '5 hours ago' },
      { id: '3', user: 'Robert Johnson', action: 'joined community cleanup', time: '1 day ago' },
    ],
  },
  {
    id: '8',
    ...
    leaderboardData: [
      ...
      { id: '4', name: 'Education First', score: 930, avatar: 'https://i.pravatar.cc/150?img=4' },
      { id: '5', name: 'Helping Hands', score: 870, avatar: 'https://i.pravatar.cc/150?img=5' },
    ],
  },
];
